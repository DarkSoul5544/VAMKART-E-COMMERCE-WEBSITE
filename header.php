...
<head>
    ...
    <link rel = "icon" href = "images/sitelogo.png" type = "image/x-icon">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <?php if(isset($title)){ ?>
        <title><?php echo $title; ?></title>
    <?php }else{ ?>
        <title>Fresher'sKart|home</title>
            ...
            <div class="col-md-2">
                <?php
                    if(!empty($header[0]['site_logo'])){ ?>
                        <a href="index.php" class="logo-img"><img src="images\projectlogo.png" alt=""></a>
                    <?php }else{ ?>
                        <a href="index.php" class="logo"><?php echo $header[0]['site_name']; ?></a>
                    <?php } ?>
            </div>
            <!-- /LOGO -->
            <div class="col-md-7">
                ...
                <div class="input-group search">
                    <input type="text" class="form-control" name="search" placeholder="What do you want today.....">
